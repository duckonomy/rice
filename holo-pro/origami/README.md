Window Management Module for Awesome WM 
=======================================

# Criteria
* This provides manual window management
* It also provides a way to resize dynamically
...
* Arbitrary resize (mod4 + g: center small, only horizontal max left/right)
* Edge resize maximize when top
* Complete framework for resizing and maximizing and a more sane window management (Origami project)
* Better title bar icons
* Better wallpaper
